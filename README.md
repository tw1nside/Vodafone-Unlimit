...
7. Порт оставляем таким-же, для более быстрого интернета выбираем **Бразилию [UPD: Или же сервер на котором меньше всего онлайна, т.к. скорость соединения будет выше]**
